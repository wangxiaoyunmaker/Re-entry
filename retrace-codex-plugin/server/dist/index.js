...
server.registerTool("open_retrace_panel", {
...
server.registerTool("get_retrace_state", {
...
server.registerTool("record_invitation_choice", {
...
server.registerTool("submit_pre_survey", {
...
server.registerTool("transition_reentry_state", {
...
server.registerTool("reconstruct_reentry_context", {
...
server.registerTool("record_context_review", {
...
server.registerTool("create_investigation", {
...
server.registerTool("edit_investigation", {
...
server.registerTool("copy_investigation", {
...
server.registerTool("record_investigation_result", {
...
server.registerTool("generate_next_prompt", {
...
server.registerTool("edit_next_prompt", {
...
server.registerTool("complete_reentry", {

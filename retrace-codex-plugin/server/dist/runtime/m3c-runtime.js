import { InvestigationSchema, NextPromptDraftSchema } from "../schemas/m3c.js";
import { deriveReviewedReentryState } from "./reviewed-state.js";
export function buildReviewedState(reconstruction, reviews, reentryRunId, investigationCandidates = []) {
...
export function buildNextPromptDraft(state, promptId, generatedAt) {
...
export function buildInvestigation(state, input) {
    ...
    if (targetId && !uncertainty && !evidence)
        throw new Error("INVESTIGATION_TARGET_NOT_FOUND");
